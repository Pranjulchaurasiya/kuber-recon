...
export function ProductConsoleSection() {
  ...
  return (
    <section className="space-y-8 py-6" id="product-console">
      ...
      <div className="rounded-xl border border-border/70 bg-panel/70 p-5 sm:p-7 shadow-sm space-y-6 hover-glow animate-fade-up stagger-2">
        {activeTab === 'capital' ? (
          <div className="space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-4 border-b border-border/60 pb-4">
              <div>
                <h3 className="text-base sm:text-lg font-bold text-foreground">Kuber Capital Merchant Terminal</h3>
              ...
              <div className="flex items-center gap-2">
                <span className="rounded-full bg-gain/10 border border-gain/20 px-3 py-1 font-mono text-xs font-semibold text-gain flex items-center gap-1.5">
          ...
          <div className="space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-4 border-b border-border/60 pb-4">
              <div>
                <h3 className="text-base sm:text-lg font-bold text-foreground">Kuber Pre-Settlement Escrow Console</h3>
                <p className="text-xs text-muted-foreground">
              ...
              <Link
                href="/console"
                className="inline-flex items-center gap-2 rounded-lg bg-foreground px-4 py-2 font-mono text-xs font-bold text-background shadow-sm transition-all hover:opacity-90"
              >
                Open Escrow Console <ArrowRight className="h-3.5 w-3.5" />
              </Link>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="rounded-lg border border-border/60 bg-card/60 p-4 space-y-2">
                ...
                <div className="text-xl sm:text-2xl font-bold font-mono text-foreground">₹2,47,089.55</div>
              ...
              <div className="rounded-lg border border-border/60 bg-card/60 p-4 space-y-2">
                ...
                <div className="text-xl sm:text-2xl font-bold font-mono text-gain">0.000</div>
              ...
              <div className="rounded-lg border border-border/60 bg-card/60 p-4 space-y-2">
                ...
                <div className="text-xl sm:text-2xl font-bold font-mono text-gold">0.10% Withheld</div>
                <div className="text-[11px] text-muted-foreground">Paise-exact base-10 deduction</div>
              </div>
            </div>

            {/* Simulated Live Event Stream */}
            <div className="rounded-lg border border-border/60 bg-muted/30 p-4 space-y-3 font-mono text-xs">
              <div className="flex items-center justify-between text-muted-foreground text-[10px] uppercase tracking-wider border-b border-border/60 pb-2">
